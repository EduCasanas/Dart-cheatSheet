//MODIFICADORES DE ACCESO PERMITE RESTRINGIR EL ACCESO A METODOS O ATRIBUTOS
// Si crearamos otro archivo e instanciamos un objeto de la clase Alumno
//podremos acceder a los metodos y atributos de la clase sin ningun problema en
//ese nuevo archivo, pero si hacemos los metodos o atributos privados
//ya no podremos acceder a ellos, solamente se podra acceder desde el mismo
//archivo.
void main() {
...
class Alumno {
  ...
  */
  ...
  obtenerPromedio() {
    ...
    print('El promedio del alumno ${this.name} es: ${_calcularPromedio()}');
  }

  _calcularPromedio() {
    return this.calificaciones.reduce((value, element) => value + element) /
